...
public class RabByungMonth: AbstractTyme {
    ...
    public var alias: String {
        (isLeap ? "闰" : "") + Self.ALIASES[month - 1]
    }

    public override  var description: String {
        "\(rabByungYear)\(getName())"
    }
    ...
    public override func next(_ n: Int) throws -> Self {
        ...
        var y: RabByungYear = rabByungYear
    ...
    public var specialDays: [Int] {
        Self.CACHE[year * 13 + indexInYear] ?? []
    }
